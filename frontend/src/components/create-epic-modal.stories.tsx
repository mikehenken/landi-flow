...
const meta: Meta<typeof CreateEpicModal> = {
  title: 'Layout/CreateEpicModal',
...
export default meta;
type Story = StoryObj<typeof CreateEpicModal>;
...
function ModalHarness({ initialOpen = true }: { initialOpen?: boolean }): React.ReactElement {
  ...
  return (
    <div className="min-h-[720px] bg-background p-6">
      <CreateEpicModal open={open} onOpenChange={setOpen} />
    </div>
  );
}
