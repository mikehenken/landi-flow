...
const meta: Meta<typeof CreateMemberModal> = {
  title: 'Layout/CreateMemberModal',
...
export default meta;
type Story = StoryObj<typeof CreateMemberModal>;
...
function ModalHarness({ initialOpen = true }: { initialOpen?: boolean }): React.ReactElement {
  ...
  return (
    <div className="min-h-[720px] bg-background p-6">
      <CreateMemberModal open={open} onOpenChange={setOpen} />
    </div>
  );
}
