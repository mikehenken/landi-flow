...
if (!conn) {
  console.error('PGURL required (env or .env.local) to apply citext extension');
  process.exit(1);
}

const migrationFiles = [
  '0032_enable_citext_extension.sql',
  '0033_fix_citext_search_path.sql',
  '0034_citext_to_citext_helper.sql',
];
